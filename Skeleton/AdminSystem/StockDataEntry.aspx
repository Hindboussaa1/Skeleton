...
<body>
    <form id="form1" runat="server">
        <div style="height: 299px; margin-left: 0px">
            ...
            <asp:Label ID="lblCarBrand" runat="server" style="z-index: 1; left: 9px; top: 47px; position: absolute; height: 18px; width: 83px" Text="Car Brand"></asp:Label>
            <br />
            <br />
            ...
            <br />
            <asp:Label ID="lblCarModel" runat="server" height="19px" style="z-index: 1; left: 9px; position: absolute; width: 96px; top: 70px;" Text="Car Model"></asp:Label>
            ...
            <br />
            <br />
            <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 12px; position: absolute; top: 278px;"></asp:Label>
            <asp:Button ID="btnFind" runat="server" CssClass="auto-style1" Height="29px" OnClick="btnFind_Click" Text="Find" Width="65px" />
            <br />
            <br />
