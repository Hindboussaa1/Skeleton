...
<body style="background-color: #9999FF">
    <form id="form1" runat="server">
        ...
        <asp:Button ID="Button1" runat="server" style="z-index: 1; left: 589px; top: 488px; position: absolute; height: 27px; width: 86px;" Text="Ok" BackColor="#DDDDDD" BorderColor="#666699" CssClass="auto-style2" OnClick="Button1_Click1" />
            <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 345px; top: 486px; position: absolute; height: 30px; bottom: 60px; right: 740px;" Text="Cancel" BackColor="#DDDDDD" BorderStyle="Inset" CssClass="auto-style2" />
