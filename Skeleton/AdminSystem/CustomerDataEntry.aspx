...
<body style="background-color: #9999FF">
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnOK" runat="server" style="z-index: 1; left: 151px; top: 497px; position: absolute; height: 27px; width: 86px;" Text="Ok" BackColor="#DDDDDD" BorderColor="#666699" CssClass="auto-style2" OnClick="btnOK_Click1" />
